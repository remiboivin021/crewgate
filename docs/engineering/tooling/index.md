...
CI pipeline configuration — trigger events, jobs, caching, artifact handling. (Template stub — to be filled with GitHub Actions workflow details.)

### [ci-policy.md](ci-policy.md)

CI policies — branch protection, required checks, merge gates, dependency update rules. (Template stub.)
...
Monitoring and observability — logs, metrics, alerts, telemetry pipeline. (Template stub.)
